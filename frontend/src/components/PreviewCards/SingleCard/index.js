...
const PreviewCards = ({ projectName, background, primary, creatorName, creatorLink, projectHref, contractAddress }) => {
    return (
        <CardHref projectHref={projectHref} projectName={projectName} background={background} primary={primary} creatorName={creatorName} contractAddress={contractAddress}>
            <CardLayout>
